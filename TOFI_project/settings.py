"""
Django settings for TOFI_project project.
...
SECRET_KEY = 'nkb9vx5qn9gjmv+972p+nj63!5b5651#(b@87+62rp92)8at!r'
...
ROOT_URLCONF = 'TOFI_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'TOFI/templates')]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'TOFI_project.wsgi.application'
